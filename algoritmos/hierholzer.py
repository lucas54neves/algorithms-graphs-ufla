...
grafo3 = Grafo(7)
grafo3.adicionar_aresta(0, 1)
grafo3.adicionar_aresta(0, 2)
grafo3.adicionar_aresta(1, 2)
grafo3.adicionar_aresta(1, 3)
grafo3.adicionar_aresta(1, 6)
grafo3.adicionar_aresta(2, 3)
grafo3.adicionar_aresta(2, 4)
grafo3.adicionar_aresta(2, 5)
grafo3.adicionar_aresta(2, 6)
grafo3.adicionar_aresta(4, 5)
grafo3.hierholzer()
